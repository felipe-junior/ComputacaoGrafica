#Trabalho feito com o Vinicius Kaio e Lucas Rocha
...
def cubo(): 
    # Perceba que a base quadrado da piramide foi feita no eixo y, no altura -1.
    # Depois apenas variamos os pontos x e z, de maneira que formasse um quadrado
    posicao = array('f',[
        -1.0, -1.0, -1.0, # A
        1.0, -1.0, -1.0, # B
        ...
        0.0,  1.0, 0.0,  # E Esta é a ponta da piramide
    ])

    # Definindo as cores dos pontos
    cor = array('f',[
        1.0, 1.0, 0.0, # A
        1.0, 0.0, 0.0, # B
        0.0, 1.0, 1.0, # C
    ...
    # Minha definição de triangulos. Para formar a pirâmide de base quadrada
    # têm muitas combinações de trinagulos possíveis para construi-la.
    indices = array('H',[
        A, D, C,
        B, D, A,
        D, C, E,
