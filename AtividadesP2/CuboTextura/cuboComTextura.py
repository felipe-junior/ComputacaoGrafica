...
def cubo():
    ...
    #Vertices do cubo, seguindo o padrão de começar
    # sempre no primeiro quadrante uma vez que o eixo z
    # fica chapado no A, B, C e D com z = 1 e no E, F, G, H fica chapado no -1
